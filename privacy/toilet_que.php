            ...
            <div class="content">
                <div class="main w3l">
                    ...
                    <!--</div>-->
                        ...
                        <p style="font-size: 2.5em;padding:20px;color:white;">Do you use your phone when you're on the toilet?</p>
...
<div class="full-screen-portfolio" id="portfolio" style="background-image: url(img/toliet.png);background-size: 100% 100%">
    ...
    <div class="video-content">
        ...
        <div class="main w3l" >
            ...
            <!--<img src="images/img1.jpg" alt="">-->
            <!--</div>-->
            <form action="toilet_video.php" method="post" name="fm0" onsubmit="0">
                <!-- end /.header-->

                <p style="font-size: 2.5em;padding:20px;color:white;">You ever had a private conversation with a stranger in a public bathroom? </p>
                <div class="main-row" style="margin-left:36%;padding:0px;">
                    <ul class="dowebok">
                        <li style=":100px;"><input type="radio" name="radio" data-labelauty="YES" value="1" ></li>
                        <li style="margin-left:20%;"><input type="radio" name="radio" data-labelauty="NO" value="2"></li>
