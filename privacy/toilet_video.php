<?php session_start();
$name = $_SESSION["name"];
$_SESSION["toilet_que_time"]=$_POST["time_spent"];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <embed src="video/toilet1.mp4" hidden="true" autostart="true"/>
...
<div class="video-container"  id="portfolio">
    ...
    <div class="video-content">
        <div class="inner">
            ...
            <div class="scroll-icon">
                <form action="toilet_blac.php" method="post" name="fm0" onsubmit="0">
    ...
    <video autoplay loop muted>
        ...
        <source src="video/toilet1.mp4" type="video/mp4"/>
    </video>
</div>
