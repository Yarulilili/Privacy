        ...
        <div class="full-screen-portfolio" >
            ...
            <div class="content">
                <div class="main w3l">
                    ...
                    <p style="font-size: 2.5em;padding:20px;color:white;">You ever had a person that you really really hated ?</p>
        ...
        <div class="video-content">
            <div class="content">
                ...
                <div class="main w3l">
                    ...
                    <!--<img src="images/img1.jpg" alt="">-->
                    <!--</div>-->
                    <form action="murder_video.php" method="post" name="fm0" onsubmit="0">
                        <!-- end /.header-->

                        <p style="font-size: 2.5em;padding:20px;color:white;">You ever thought about killing someone ?</p>
                        <div class="main-row" style="margin-left:36%;padding:0px;">
                            <ul class="dowebok">
                                <li><input type="radio" name="radio" data-labelauty="YES" value="1" ></li>
                                <li style="margin-left:20%;"><input type="radio" name="radio" data-labelauty="NO" value="2"></li>
