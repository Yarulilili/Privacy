...
<body style="background-image: url(img/welcome.jpg);">
<a href="name.php">
    <!--<a href="welcome.html">-->
    <div class="video-container" style="background-image:url(img/eye.png);background-size: 100% 100%">
        <div class="video-content">
            <div class="inner">
                <h1><em>LET THE GAME </em>BEGIN </h1>
