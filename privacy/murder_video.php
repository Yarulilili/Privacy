<?php session_start();
$name = $_SESSION["name"];
$_SESSION["murder_que_time"]=$_POST["time_spent"];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <embed src="video/murder1.mp4" hidden="true" autostart="true"/>
...
<!--            <div class="scroll-icon">-->
                <form action="alone.php" method="post" name="fm0" onsubmit="0">
...
<!--        </div>-->
    ...
    <video autoplay loop muted>
        ...
        <source src="video/murder1.mp4" type="video/mp4"/>
    </video>
</div>
