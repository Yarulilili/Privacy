<?php session_start();
$name = $_SESSION["name"];
//$_SESSION["public_video_time"]=$_POST["time_spent"];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="video-container" style="background-image: url(img/toliet.png); background-size: 100% 100%">
        ...
        <div class="full-screen-portfolio">
            ...
            <div class="content">
                <div class="main w3l">
                    ...
                    <p style="font-size: 2.5em;padding:20px;color:white;"><?php echo $name ?>, you ever got some time alone for yourself when you're home ?</p>
                    <div class="main-row" style="margin-left:36%;padding:0px;">
                        <ul class="dowebok">
                            <li style=":100px;"><input type="radio" name="radio" data-labelauty="YES" value="1" ></li>
                            <li style="margin-left:20%;"><input type="radio" name="radio" data-labelauty="NO" value="2"></li>
                        </ul>
                    </div>
                    <div class="scroll-icon"  style="margin-left:47%;margin-top:20px;">
...
<div class="full-screen-portfolio" id="portfolio" style="background-image: url(img/toliet.png);background-size: 100% 100%">
        ...
        <div class="video-content">
            <div class="content">
                ...
                <div class="main w3l" >
                    ...
                    <!--<img src="images/img1.jpg" alt="">-->
                    <!--</div>-->
                    <form action="public_video.html" method="post" name="fm0" onsubmit="0">
                        <!-- end /.header-->

                        <p style="font-size: 2.5em;padding:20px;color:white;">Is it possible for two people to have a private conversation nowadays ? </p>
                        <div class="main-row" style="margin-left:36%;padding:0px;">
                            <ul class="dowebok">
                                <li style=":100px;"><input type="radio" name="radio" data-labelauty="YES" value="1" ></li>
                                <li style="margin-left:20%;"><input type="radio" name="radio" data-labelauty="NO" value="2"></li>
                        ...
                        <div class="scroll-icon">
                            <input type="image" lass="scrollTo" name="" src="img/scroll-icon-next.png"
                                   Oninclick="document.formName.submit()" style="margin-left:46%;">
                        </div>
