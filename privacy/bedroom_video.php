<?php session_start();
$name = $_SESSION["name"];
$_SESSION["bed_que_time"]=$_POST["time_spent"];
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <embed src="video/bedroom1.mp4" hidden="true" autostart="true"/>
...
<!--        <div class="inner">-->
<!--            <h1>Bedroom <em>?</em></h1>-->
            <!--<p>What's going on in your bedroom ?</p>-->
<!--            <p></p>-->

                <form action="murder_que.php" method="post" name="fm0" onsubmit="0">
...
<!--        </div>-->
    ...
    <video autoplay loop muted>
        ...
        <source src="video/bedroom1.mp4" type="video/mp4"/>
    </video>
</div>
