...
$_SESSION["name"]=$_POST["test_name"];
//$_SESSION["name_time"]=$_POST["name_spent"];
...
<div class="video-container">
    ...
    <div class="video-content">
        <div class="inner" style="margin-top:20px;">
            ...
            <form action="intro.php" method="post" name="fm0" onsubmit="0">
                <input type="text" class="name" name="test_address"  style="margin-top:20px;" required/>
